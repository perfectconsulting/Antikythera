...
${OBJECTDIR}/abstractmachine.o: abstractmachine.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/abstractmachine.o abstractmachine.c

${OBJECTDIR}/bytecodeassembler.o: bytecodeassembler.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/bytecodeassembler.o bytecodeassembler.c

${OBJECTDIR}/heapmanager.o: heapmanager.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/heapmanager.o heapmanager.c

${OBJECTDIR}/keystore.o: keystore.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/keystore.o keystore.c

${OBJECTDIR}/lexical.o: lexical.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lexical.o lexical.c
...
${OBJECTDIR}/stringpool.o: stringpool.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/stringpool.o stringpool.c
